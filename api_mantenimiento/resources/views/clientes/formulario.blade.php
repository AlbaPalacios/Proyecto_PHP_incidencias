    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{-- {{ route('admin.cliente.crear.post') }} --}}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="numero_cuenta" class="col-md-4 col-form-label text-md-end">{{ __('Numero de cuenta') }}</label>

                            <div class="col-md-6">
                                <input id="numero_cuenta" type="text" class="form-control @error('numero_cuenta') is-invalid @enderror" name="numero_cuenta" value="{{ old('numero_cuenta') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="pais" type="text" class="form-control @error('pais') is-invalid @enderror" name="pais" value="{{ old('pais') }}" required>
